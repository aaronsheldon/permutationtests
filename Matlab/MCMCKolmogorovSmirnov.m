...
% Date.......: April, 2010
% Description: Markov Chain Monte Carlo draws from the distribution of the Kolmogorov 
...
%              the first estimator is above the second; and the fraction of
%              the curve where the first estimator is below the second.
%
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
%                                                                         %
...
%
function DistanceStatistic = MCMCKolmogorovSmirnov(SamplePoints, SampleCount, DrawCount)
  ...
  for DrawIndex = 2:DrawCount,
    ...
    SwapIndex                   = randi(SampleCount, 2, 1);
    CompareSample(SwapIndex, 1) = CompareSample(SwapIndex([2; 1], 1), 1);
