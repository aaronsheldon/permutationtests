...
% Date.......: April, 2010
% Description: Monte Carlo draws of the Spearman rank correlation coefficient,
%              calculated by permuting a list of ranks generated from a 
%              list of tie counts.
%
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
%                                                                         %
...
%
function CorrelationStatistic = MonteCarloSpearman(TiesOne, TiesTwo, DrawCount)
