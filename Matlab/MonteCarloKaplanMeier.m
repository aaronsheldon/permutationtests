...
% Date.......: April, 2010
% Description: Monte Carlo draws from the uniform distribution on the
...
%              the second estimator; the distance the first estimator
%              is below the second estimator; the fraction of the curve
...
%
function DistanceStatistic = MonteCarloKaplanMeier(OutcomePoints, CensorPoints, SampleCount, DrawCount)
